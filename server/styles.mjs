...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.03a83356.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.2b126dad.mjs').then(interopDefault),
